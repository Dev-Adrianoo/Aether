...
class TestVisionHearingIntegration:
    ...
    async def test_trigger_word_capture_integration(self, vision_manager, hearing_listener):
        ...
        command_text = "aether tira um print da tela"
    ...
    async def test_command_classification_integration(self, hearing_listener):
        ...
        test_commands = [
            ("aether tira um print", "screenshot"),
            ("aether captura a tela", "screenshot"),
            ("aether mostra como está", "screenshot"),
            ("aether olha aqui", "screenshot"),
            ("aether tira uma foto", "screenshot"),
        ]
    ...
    async def test_wake_word_processing_flow(self, hearing_listener):
        ...
        await hearing_listener._process_audio_text("aether tira um print da tela por favor")
